...
import { exportFigmaTokensStudio } from './figma-tokens-studio';
...
import { exportAdobeXD } from './adobe-xd';
...
export function initializeExporters(): void {
  ...
  registerExporter(exportFigmaTokensStudio);
  ...
  registerExporter(exportAdobeXD);
...
export * from './figma-tokens-studio';
